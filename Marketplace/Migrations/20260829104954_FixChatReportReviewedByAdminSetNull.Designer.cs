...
namespace Marketplace.Migrations
{
    ...
    [Migration("20260829104954_FixChatReportReviewedByAdminSetNull")]
    partial class FixChatReportReviewedByAdminSetNull
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Marketplace.Models.ChatReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ReporterId", "ThreadKey")
                        .IsUnique();
            ...
            modelBuilder.Entity("Marketplace.Models.ChatReport", b =>
                {
                    ...
                    b.HasOne("Marketplace.Models.ApplicationUser", "ReportedUser")
                        .WithMany()
                        .HasForeignKey("ReportedUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Marketplace.Models.ApplicationUser", "Reporter")
                        .WithMany()
                        .HasForeignKey("ReporterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Marketplace.Models.ApplicationUser", "ReviewedByAdmin")
                        .WithMany()
