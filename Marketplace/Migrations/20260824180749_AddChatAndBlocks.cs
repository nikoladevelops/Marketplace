...
{
    /// <inheritdoc />
    public partial class AddChatAndBlocks : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsReadByReceiver = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatMessages_Advertisements_AdvertisementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_AdvertisementId",
                table: "ChatMessages",
                column: "AdvertisementId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_ReceiverId_IsReadByReceiver",
                table: "ChatMessages",
                columns: new[] { "ReceiverId", "IsReadByReceiver" });
