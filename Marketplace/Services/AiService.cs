...
namespace Marketplace.Services
{
    public class AiService(HttpClient httpClient, ApplicationDbContext context) : IAiService
    {
        ...
        public async Task<GeneratedListingDto?> GenerateListingFromImagesAsync(IEnumerable<IFormFile> imageFiles, CancellationToken cancellationToken)
        {
            ...
            if (validFiles == null || validFiles.Count == 0) return null;
            ...
            // Focus strictly on the primary/main image to prevent multi-image token confusion and hallucinations
            ...
            try
            {
                ...
                // Clean potential markdown block wrappers if the model fails to obey instructions
